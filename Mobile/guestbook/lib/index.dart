...
import 'package:guestbook/auth/register_block/register_bloc.dart';
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: layout.getHeight() *2, left: layout.getHeight() *2, right: layout.getHeight() *2 ),
                    child: Container(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: layout.getHeight() *1, left: layout.getHeight() *1, right: layout.getHeight() *1 ),
                    child: Container(
                      width: layout.getWidth() *80,
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            icon: Icon(Icons.person,size: 32,color: Theme.of(context).primaryColor),
                            labelText: "Email",
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: layout.getHeight() *1, right: layout.getHeight() *1 ),
                    child: Container(
                      width: layout.getWidth() *80,
                      height: layout.getHeight() * 10,
                      // color: Colors.amber,
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            icon: Icon(Icons.lock,size: 32,color: Theme.of(context).primaryColor),
                            labelText: "Password",
                            labelStyle: TextStyle(
                                color: Theme.of(context).primaryColor)
                        ),
                      ...
                      onTap: ()async{
                        ...
                        logindata.login(Parameter()).then((value) {
                          ...
                          if(value["success"].toString() == "true"){
                            ...
                            print("Error : " + value["nError"].toString() + " : " + value["sError"] );
                            Navigator.of(context,rootNavigator: true).pop();

                            messageBox(context: context, title: "Error", message: value["nError"].toString() + " : " + value["sError"]);
                          }
                        });
                      },
                    ),
